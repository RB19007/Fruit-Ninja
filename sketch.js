...
function setup() {
  createCanvas(480,410);
   ...
   canvas = createSprite(200,200,10,10);
   canvas.addImage(canvasImage);
   gameOver = createSprite(230,200,10,10);
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    monster.y=Math.round(random(20,400));
  ...
  if(World.frameCount%80===0){
    ...
    else
    {
     ...
     //update below give line of code for increase fruitGroup speed by 4
      ...
      monster.velocityX = monster.velocityX -2;
    }
      }
    }
    ...
    fruit.y=Math.round(random(20,400));
